...
description: Use when creating, refreshing, diagnosing, or connecting through OCI Bastion managed SSH sessions with the `bastion-session` CLI for tracked OCI compute hosts.
---
